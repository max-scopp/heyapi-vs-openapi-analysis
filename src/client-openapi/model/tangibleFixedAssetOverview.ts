...
export interface TangibleFixedAssetOverview { 
    yearEndReport?: YearEndReport;
    incomeGroupId?: number;
    businessActivityType?: TangibleFixedAssetOverview.BusinessActivityTypeEnum;
    readonly industryId?: number;
    readonly businessActivityDescription?: string;
    posts?: Array<TangibleFixedAsset>;
}
export namespace TangibleFixedAssetOverview {
